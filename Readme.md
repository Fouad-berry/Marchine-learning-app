...
une web app de machine learning utilisant l'api de openai pour repondre aux questions de l'utilisateur, le tout en utilisant l'api publique de open ai et le modèle de donnée gpt3 alimentant l'app web.
